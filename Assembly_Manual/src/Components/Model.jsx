...
export default function Model({ modelIn, modelOut, modelInCopy, modelInCopy2, modelOutCopy }) {
    ...
    const preparingStepArray = [ //shown grouped
        [
            "012_Fix_back_left_corner_profile_linear_guide"
        ],
        [
            "021_Prepare_front_frame",
            "022_Prepare_front_left_corner_profile",
            "023_Fix_front_left_corner_profile",
            "024_Fix_front_right_corner_profile",
            "025_Fix_front_top_profile"
        ],
        [
            "10_Prepare_inner_panel_back"
        ],
        [
            "16_Prepare_Y_axis_beams"
        ],
        [
            "171_Prepare_gantry_back_left_corner_1",
            "172_Prepare_gantry_back_left_corner_2",
            "173_Prepare_gantry_back_left_corner_3"
        ],
        [
            "181_Prepare_gantry_back_right_corner_1",
            "182_Prepare_gantry_back_right_corner_2",
            "183_Prepare_gantry_back_right_corner_3"
        ],
        [
            "191_Prepare_gantry_front_left_corner_1",
            "192_Prepare_gantry_front_left_corner_2"
        ],
        [
            "201_Prepare_gantry_front_right_corner_1",
            "202_Prepare_gantry_front_right_corner_2"
        ],
        [
            "221_Prepare_X_left_connection_1",
            "222_Prepare_X_left_connection_2"
        ],
        [
            "231_Prepare_X_right_connection_1",
            "232_Prepare_X_right_connection_2"
        ],
        [
            "241_Prepare_X_axis_-_linear_guides",
            "242_Prepare_X_axis_-_left_and_right_connections",
            "243_Prepare_X_axis_-_carriages_attachments"
        ],
        [
            "271_Prepare_Z_motor_brackets_1",
            "272_Prepare_Z_motor_brackets_2",
            "273_Prepare_Z_motor_brackets_3"
        ],
        [
            "34_Prepare_head_bottom_holder"
        ],
        [
            "40_Prepare_the_camera"
        ],
        [
            "44_Prepare_back_panel"
        ],
        [
            "46_Prepare_back_side_panel"
        ],
        [
            "481_Prepare_the_bed",
            "482_Fix_the_3D_Printing_Plates",
            "483_Fix_bed_support_plates",
            "484_Fix_the_bed_beams"
        ],
        [
            "501_Prepare_back_bottom_panel",
            "502_Attach_back_bed_beam_support_panel"
        ],
        [
            "51_Prepare_front_bottom_panel"
        ],
        [
            "53_Prepare_front_right_panel_top"
        ],
        [
            "541_Prepare_front_right_panel_bottom_1",
            "542_Prepare_front_right_panel_bottom_2"
        ],
        [
            "65_Prepare_electronic_covers"
        ],
        [
            "66_Prepare_left_side_bottom_panel"
        ],
        [
            "69_Prepare_front_doors"
        ],
        [
            "70_Prepare_side_doors"
        ]
    ]
